...
public class ExpenseService {
     ...
     */
     ...
     public ExpenseEntity addExpense(ExpenseEntity expense , Long budgetId){
        ...
        if(newTotal > budget.getCategoryLimit()){
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST , String.format("Adding this expense would exceed budget limit. Current total: %.2f, Budget limit: %.2f, New expense: %.2f" ,
    ...
    public ExpenseEntity editExpense(Long id,ExpenseEntity updatedExpense,Long budgetId){
       ...
       if(newTotal > budget.getCategoryLimit()){
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST , String.format("Adding this expense would exceed budget limit. Current total: %.2f, Budget limit: %.2f, updated expense: %.2f" ,
